...
ansible 127.0.0.1 -i ./inventory/hosts -m template -a "src=./harbor/sentry/config.toml dest=$sentry_conf" -e "harbor_vip=$harbor_vip" -e "harbor_protocol=$harbor_protocol"
